...
public final class ActivityMainSimpleBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityMainSimpleBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMainSimpleBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_main_simple, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMainSimpleBinding bind(@NonNull View rootView) {
