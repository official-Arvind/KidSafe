...
public final class FragmentPhotoBinding implements ViewBinding {
  ...
  private FragmentPhotoBinding(@NonNull LinearLayout rootView, @NonNull TextView statusTextView) {
  ...
  public static FragmentPhotoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPhotoBinding((LinearLayout) rootView, statusTextView);
    }
