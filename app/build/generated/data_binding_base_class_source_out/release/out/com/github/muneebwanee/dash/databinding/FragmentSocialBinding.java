...
public final class FragmentSocialBinding implements ViewBinding {
  ...
  private FragmentSocialBinding(@NonNull LinearLayout rootView, @NonNull TextView statusTextView) {
  ...
  public static FragmentSocialBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSocialBinding((LinearLayout) rootView, statusTextView);
    }
