...
import com.github.muneebwanee.dash.ui.widget.CustomEditText;
...
public final class ViewChangeCodeAccessBinding implements ViewBinding {
  ...
  private ViewChangeCodeAccessBinding(@NonNull LinearLayout rootView,
      @NonNull CustomEditText currentAccessCode, @NonNull CustomEditText newAccessCode,
      @NonNull CustomEditText repeatAccessCode) {
  ...
  public static ViewChangeCodeAccessBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      CustomEditText currentAccessCode = ViewBindings.findChildViewById(rootView, id);
      if (currentAccessCode == null) {
        break missingId;
      }

      id = R.id.new_access_code;
      CustomEditText newAccessCode = ViewBindings.findChildViewById(rootView, id);
      if (newAccessCode == null) {
        break missingId;
      }

      id = R.id.repeat_access_code;
      CustomEditText repeatAccessCode = ViewBindings.findChildViewById(rootView, id);
