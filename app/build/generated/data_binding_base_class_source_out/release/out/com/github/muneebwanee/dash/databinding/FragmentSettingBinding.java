...
import com.github.muneebwanee.dash.ui.widget.CustomNestedScrollView;
...
public final class FragmentSettingBinding implements ViewBinding {
  ...
  @NonNull
  public final CustomCheckBox checkEnableAppFinish;

  @NonNull
  public final CustomCheckBox checkEnableCodeAccess;
  ...
  private FragmentSettingBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull CustomCheckBox checkEnableAppFinish, @NonNull CustomCheckBox checkEnableCodeAccess,
      @NonNull CoordinatorLayout mainView, @NonNull CustomNestedScrollView nestedScroll,
  ...
  public static FragmentSettingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      CustomCheckBox checkEnableAppFinish = ViewBindings.findChildViewById(rootView, id);
      if (checkEnableAppFinish == null) {
        break missingId;
      }

      id = R.id.check_enable_code_access;
      CustomCheckBox checkEnableCodeAccess = ViewBindings.findChildViewById(rootView, id);
      ...
      CustomNestedScrollView nestedScroll = ViewBindings.findChildViewById(rootView, id);
